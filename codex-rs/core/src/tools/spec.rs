...
impl ToolsConfig {
    ...
    pub fn with_provider_is_openai(mut self, provider_is_openai: bool) -> Self {
        self.provider_is_openai = provider_is_openai;
        self
    }
