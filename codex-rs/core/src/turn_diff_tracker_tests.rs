...
async fn accumulates_add_then_update_as_single_add() {
    ...
    .await;
    tracker.track_delta_for_environment("", &add);
    ...
    .await;
    tracker.track_delta_for_environment("", &update);
...
async fn tracks_same_absolute_path_across_multiple_environments() {
    ...
    tracker.track_delta_for_environment("remote", &add);
    tracker.track_delta_for_environment("local", &add);
...
async fn accumulates_delete() {
    ...
    .await;
    tracker.track_delta_for_environment("", &delete);
...
async fn pure_rename_yields_no_diff() {
    ...
    .await;
    tracker.track_delta_for_environment("", &rename);
...
async fn move_over_existing_destination_without_content_change_deletes_source_only() {
    ...
    .await;
    tracker.track_delta_for_environment("", &move_overwrite);
...
async fn preserves_committed_change_order_with_delete_then_move_overwrite() {
    ...
    .await;
    tracker.track_delta_for_environment("", &ordered_patch);
